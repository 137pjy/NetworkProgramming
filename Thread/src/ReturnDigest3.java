...
public class ReturnDigest3 extends Thread {

    private String filename;
    private byte[] digest;

    public ReturnDigest3(String filename) {
    ...
    public static void main(String[] args) throws IOException, NoSuchAlgorithmException, InterruptedException {
        ...
        ReturnDigest3[] digests = new ReturnDigest3[file.length];

        for (int i = 0; i < file.length; i++) {
            digests[i] = new ReturnDigest3(file[i]);
            digests[i].start();
        }
